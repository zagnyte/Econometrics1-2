...
Firstly, we need to install the **"tm"**, **"wordcloud"** and **"RColorBrewer"** libraries that we will be using for our text analysis and set our working directory to where we saved our CSV file.
